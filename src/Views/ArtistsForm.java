...
public class ArtistsForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtArtistsBio = new javax.swing.JTextArea();
        ...
        txtArtistsBio.setColumns(20);
        txtArtistsBio.setRows(5);
        jScrollPane1.setViewportView(txtArtistsBio);
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        String bio = txtArtistsBio.getText();
        artistsController.insert(new Artists(name, bio));
    }//GEN-LAST:event_btnSaveActionPerformed

    private void btnCleanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCleanActionPerformed
        // TODO add your handling code here:
        txtArtistName.setText("");
        txtArtistsBio.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ArtistsForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ArtistsForm().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextArea txtArtistsBio;
